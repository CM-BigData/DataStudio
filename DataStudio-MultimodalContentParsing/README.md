...
- Runtime dependencies are managed in `pyproject.toml`, including Click, Pydantic, PyYAML, python-docx, pandas, openpyxl, xlrd, Pillow, RapidOCR ONNX Runtime, soundfile, and the OpenAI SDK.
