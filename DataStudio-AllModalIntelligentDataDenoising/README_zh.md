...
- 主要 Python 依赖见 `pyproject.toml`：`numpy`、`opencv-python`、`Pillow`、`PyYAML`、`requests`、`id-validator`、`phonenumbers`、`email-validator`、`python-stdnum`、`validators`、`lingua-language-detector`、`scikit-image`、`ImageHash`、`rapidfuzz`、`regex`
...
{"id":"pair_001","payload":{"text":"图片描述文本","image_path":"example_data/assets/images/local_real_smoke/image_clean_bird.jpg"}}
