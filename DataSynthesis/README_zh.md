...
- [快速开始](#dr-quick-start)
- [命令行用法](#dr-cli)
- [运行数据生成 workflow](#dr-运行数据生成-workflow)
- [输入与输出](#dr-输入与输出)
- [内置 workflow 与算子](#dr-内置-workflow-与算子)
- [注意事项](#dr-注意事项)
- [开发手册](#dr-开发手册)
- [版权与许可证](#dr-版权与许可证)
...
- Python >= 3.10
- 推荐使用 `uv`
- 运行依赖来自 [`pyproject.toml`](pyproject.toml)：`click`、`openai`、`PyYAML`、`Pillow`、`tenacity`、`httpx[socks]`
- 开发测试依赖：`pytest`
...
算子开发、项目结构和测试说明见 [开发指南](README_dev_zh.md)。
